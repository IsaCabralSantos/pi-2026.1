...
const Color primaryColor = Color(0xFFDE1212);
const Color paletteRed = Color(0xFFB70000);
const Color darkTextColor = Color(0xFF1E1E1E);
const Color blackColor = Color(0xFF000000);
const Color whiteColor = Color(0xFFFFFFFF);
const Color backgroundLight = Color(0xFFF4F6F8);
const Color backgroundLighter = Color(0xFFF2F2F2);
